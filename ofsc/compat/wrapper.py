...
class OFSC:
    ...
    def _setup_event_loop(self):
        ...
        try:
            ...
            self._executor = ThreadPoolExecutor(max_workers=1, thread_name_prefix="ofsc-compat")
        ...
        try:
            if self._loop.is_running():
                ...
                if self._executor:
                    ...
                    raise RuntimeError("Cannot run async code in running event loop without executor")
            else:
    ...
    def __str__(self) -> str:
        ...
        return f"OFSC(compat, instance={self._config.get('instance')}, async_backend=v3.0)"
