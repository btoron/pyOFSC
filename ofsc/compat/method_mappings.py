...
CORE_METHODS = {
    ...
    # Resource Management
    'get_resource': {
        'params': ['resource_id', 'inventories', 'workSkills', 'workZones', 'workSchedules'], 
        'defaults': {'inventories': False, 'workSkills': False, 'workZones': False, 'workSchedules': False},
    ...
    'get_resource_descendants': {
        'params': ['resource_id', 'resourceFields', 'offset', 'limit', 'inventories', 'workSkills', 'workZones', 'workSchedules'], 
        'defaults': {'resourceFields': None, 'offset': 0, 'limit': 100, 'inventories': False, 'workSkills': False, 'workZones': False, 'workSchedules': False},
...
METADATA_METHODS = {
    ...
    'get_capacity_areas': {
        ...
        'defaults': {'expandParent': False, 'fields': ['label'], 'activeOnly': False, 'areasOnly': False},
...
CAPACITY_METHODS = {
    'getAvailableCapacity': {
        'params': ['dates', 'areas', 'categories', 'aggregateResults', 'availableTimeIntervals', 'calendarTimeIntervals', 'fields'], 
        'defaults': {'categories': None, 'aggregateResults': None, 'availableTimeIntervals': 'all', 'calendarTimeIntervals': 'all', 'fields': None},
        'doc': 'Get available capacity'
    },
    'getQuota': {
        'params': ['dates', 'areas', 'categories', 'aggregateResults', 'categoryLevel', 'intervalLevel', 'returnStatuses', 'timeSlotLevel'], 
        'defaults': {'areas': None, 'categories': None, 'aggregateResults': None, 'categoryLevel': None, 'intervalLevel': None, 'returnStatuses': None, 'timeSlotLevel': None},
