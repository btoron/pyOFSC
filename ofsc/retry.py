...
class CircuitBreaker:
    ...
    def _transition_to_half_open(self):
        ...
        self.stats.state_transitions.append((datetime.now(), "HALF_OPEN"))
    ...
    def _on_success(self):
        ...
        if self.state == CircuitBreakerState.HALF_OPEN:
            ...
            self.stats.state_transitions.append((datetime.now(), "CLOSED"))
    ...
    def _on_failure(self, exception: Exception):
        ...
        if (
            ...
            self.stats.state_transitions.append((datetime.now(), "OPEN"))
    ...
    def reset(self):
        ...
        self.stats.state_transitions.append((datetime.now(), "CLOSED (MANUAL_RESET)"))
...
class RetryHandler:
    ...
    def _calculate_delay(self, attempt: int, exception: Exception) -> float:
        ...
        if isinstance(exception, OFSRateLimitException) and hasattr(
