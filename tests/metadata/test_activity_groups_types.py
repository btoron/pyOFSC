...
def test_get_activity_types_with_model(instance, demo_data, pp):
    instance.auto_model = True
    expected_activity_types = demo_data.get("metadata").get("expected_activity_types")
    raw_response = instance.metadata.get_activity_types(offset=0, limit=30)
    logging.debug(pp.pformat(raw_response))
