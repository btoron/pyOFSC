...
from ofsc.models import (
    core, metadata, capacity, auth, base
)
...
class SchemaModelMapper:
    ...
    def get_model_class_by_schema_name(self, schema_name: str) -> Optional[Type[BaseModel]]:
        """
        ...
        for module in modules_to_scan:
            for name, obj in inspect.getmembers(module, inspect.isclass):
                ...
                if (issubclass(obj, BaseModel) and 
                    obj.__module__ == module.__name__ and  # Defined in this module
                    obj != BaseModel and  # Not the base class itself
                    obj != BaseOFSResponse):  # Not the base response class
    ...
    def generate_mapping_report(self, schema_names: List[str]) -> Dict[str, Any]:
        ...
        return {
            ...
            'mapping_coverage': len(mapped_schemas) / len(schema_names) if schema_names else 0,
