...
class TestWorkingModelsValidation:
    ...
    def test_translation_model_validation(self):
        ...
        translation = Translation(language="en", name="Hello World")
        ...
        translation_with_iso = Translation(
            language="es", name="Hola Mundo", languageISO="es-ES"
        )
    ...
    def test_get_activity_request_validation(self):
        ...
        non_scheduled_request = GetActivityRequest(
            resources=["TECH001"], includeNonScheduled=True
        )
    ...
    def test_bulk_update_models_validation(self):
        ...
        request = BulkUpdateRequest(activities=[activity_item], updateParameters=params)
    ...
    def test_model_inheritance_and_configuration(self):
        ...
        assert not issubclass(
            Translation, BaseOFSResponse
        )  # Translation doesn't inherit from BaseOFSResponse
    ...
    def test_required_field_validation(self):
        ...
        with pytest.raises(ValueError, match="dateFrom and dateTo are required"):
            GetActivityRequest(
                resources=["TECH001"]
            )  # includeNonScheduled=False by default
    ...
    def test_models_with_extra_fields(self):
        ...
        quota_data = {"dates": ["2024-01-15"], "areas": ["AREA1"]}
        ...
        with pytest.raises(ValidationError):
            GetQuotaRequest(
                dates=["2024-01-15"], areas=["AREA1"], extraField="should be rejected"
            )
    ...
    def test_model_serialization(self):
        ...
        request = BulkUpdateRequest(
            activities=[BulkUpdateActivityItem(activityId=123, status="started")],
    ...
    def test_csv_list_edge_cases(self):
        ...
        assert clean_list == [
            "item1",
            "item2",
        ]  # whitespace trimmed, empty items removed
