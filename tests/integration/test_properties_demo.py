...
class TestPropertiesAPI(BaseOFSCTest):
    ...
    async def test_create_properties(self):
        ...
        # Validate response
        self.assert_pydantic_model_valid(created_properties.dict(), type(created_properties))
    ...
    async def test_get_properties_by_id(self):
        ...
        # Validate response
        self.assert_pydantic_model_valid(retrieved_properties.dict(), type(retrieved_properties))
    ...
    async def test_update_properties(self):
        ...
        # Validate response
        self.assert_pydantic_model_valid(updated_properties.dict(), type(updated_properties))
        self._validate_properties_response(updated_properties.dict())
        
        # Verify updates were applied
        assert updated_properties.name == updated_data['name']
        assert updated_properties.label == properties_data['label']  # Should remain same
