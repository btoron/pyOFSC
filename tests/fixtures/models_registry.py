...
MODELS: Dict[str, ModelInfo] = {
    ...
    "ActivityTypeGroupForPut": ModelInfo(
        ...
        used_in_request_endpoints=[
            "PUT /rest/ofscMetadata/v1/activityTypeGroups/{label}"
        ],
    ...
    "ActivityTypeGroup": ModelInfo(
        ...
        used_in_endpoints=[
            "GET /rest/ofscMetadata/v1/activityTypeGroups/{label}",
            "PUT /rest/ofscMetadata/v1/activityTypeGroups/{label}",
        ],
        used_in_request_endpoints=[],
        used_in_response_endpoints=[
    ...
    "ActivityType": ModelInfo(
        ...
        inheritance=[],
        used_in_endpoints=[
            "GET /rest/ofscMetadata/v1/activityTypes/{label}",
            "PUT /rest/ofscMetadata/v1/activityTypes/{label}",
        ],
        used_in_request_endpoints=[],
        used_in_response_endpoints=[
            "GET /rest/ofscMetadata/v1/activityTypes/{label}",
    ...
    "ApplicationApiAccesses": ModelInfo(
        ...
        used_in_request_endpoints=[],
        used_in_response_endpoints=[
            "GET /rest/ofscMetadata/v1/applications/{label}/apiAccess"
        ],
        mapped_pydantic_class=None,
        module="metadata",
        schema_type="object",
    ...
    "Application": ModelInfo(
        ...
        inheritance=[],
        used_in_endpoints=[
            "GET /rest/ofscMetadata/v1/applications/{label}",
            "PUT /rest/ofscMetadata/v1/applications/{label}",
        ],
        used_in_request_endpoints=[],
        used_in_response_endpoints=[
            "GET /rest/ofscMetadata/v1/applications/{label}",
    ...
    "ApiConfiguration": ModelInfo(
        ...
        inheritance=[],
        used_in_endpoints=[
            "GET /rest/ofscMetadata/v1/applications/{label}/apiAccess/{apiLabel}"
        ],
        used_in_request_endpoints=[],
        used_in_response_endpoints=[
            "GET /rest/ofscMetadata/v1/applications/{label}/apiAccess/{apiLabel}"
        ...
        examples=[],
        nested_models=[
            "ApplicationApiAccessEntity",
            "ApplicationApiAccessContextUser",
            "ApplicationApiAccessMethod",
            "ApplicationApiAccessContext",
        ],
        parent_models=[],
    ),
    "ApiConfigurationPatch": ModelInfo(
        ...
        inheritance=[],
        used_in_endpoints=[
            "PATCH /rest/ofscMetadata/v1/applications/{label}/apiAccess/{apiLabel}",
            "PATCH /rest/ofscMetadata/v1/applications/{label}/apiAccess/{apiLabel}",
        ],
        used_in_request_endpoints=[
            "PATCH /rest/ofscMetadata/v1/applications/{label}/apiAccess/{apiLabel}"
    ...
    "ApplicationClientSecret": ModelInfo(
        ...
        inheritance=[],
        used_in_endpoints=[
            "POST /rest/ofscMetadata/v1/applications/{label}/custom-actions/generateClientSecret"
        ],
        used_in_request_endpoints=[],
        used_in_response_endpoints=[
            "POST /rest/ofscMetadata/v1/applications/{label}/custom-actions/generateClientSecret"
    ...
    "Error": ModelInfo(
        ...
        nested_models=[],
        parent_models=[
            "bulkUpdateWorkSchedulesResponseSchema",
            "bulkUpdateWorkSkillsResponseSchema",
            "bulkUpdateWorkZonesResponseSchema",
            "bulkUpdateResourceInventoriesResponseResultSchema",
        ],
    ),
    "CapacityAreas": ModelInfo(
        ...
        used_in_endpoints=[
            ...
            "GET /rest/ofscMetadata/v1/capacityAreas/{label}/children",
        ],
        used_in_request_endpoints=[],
        used_in_response_endpoints=[
            "GET /rest/ofscMetadata/v1/capacityAreas",
    ...
    "AreaCapacityCategories": ModelInfo(
        ...
        inheritance=[],
        used_in_endpoints=[
            "GET /rest/ofscMetadata/v1/capacityAreas/{label}/capacityCategories"
        ],
        used_in_request_endpoints=[],
        used_in_response_endpoints=[
            "GET /rest/ofscMetadata/v1/capacityAreas/{label}/capacityCategories"
    ...
    "AreaWorkZonesOld": ModelInfo(
        ...
        used_in_request_endpoints=[],
        used_in_response_endpoints=[
            "GET /rest/ofscMetadata/v1/capacityAreas/{label}/workZones"
        ],
        mapped_pydantic_class=None,
        module="metadata",
        schema_type="object",
    ...
    "AreaTimeSlots": ModelInfo(
        ...
        used_in_request_endpoints=[],
        used_in_response_endpoints=[
            "GET /rest/ofscMetadata/v1/capacityAreas/{label}/timeSlots"
        ],
        mapped_pydantic_class=None,
        module="metadata",
        schema_type="object",
    ...
    "AreaTimeIntervals": ModelInfo(
        ...
        inheritance=[],
        used_in_endpoints=[
            "GET /rest/ofscMetadata/v1/capacityAreas/{label}/timeIntervals"
        ],
        used_in_request_endpoints=[],
        used_in_response_endpoints=[
            "GET /rest/ofscMetadata/v1/capacityAreas/{label}/timeIntervals"
    ...
    "AreaOrganizations": ModelInfo(
        ...
        inheritance=[],
        used_in_endpoints=[
            "GET /rest/ofscMetadata/v1/capacityAreas/{label}/organizations"
        ],
        used_in_request_endpoints=[],
        used_in_response_endpoints=[
            "GET /rest/ofscMetadata/v1/capacityAreas/{label}/organizations"
    ...
    "CapacityCategory": ModelInfo(
        ...
        inheritance=[],
        used_in_endpoints=[
            "PUT /rest/ofscMetadata/v1/capacityCategories/{label}",
            "GET /rest/ofscMetadata/v1/capacityCategories/{label}",
            "PUT /rest/ofscMetadata/v1/capacityCategories/{label}",
        ],
        used_in_request_endpoints=[
            "PUT /rest/ofscMetadata/v1/capacityCategories/{label}"
    ...
    "TranslationInvType": ModelInfo(
        ...
        parent_models=[
            ...
            "ResponseCreateInventoryTypeSchema",
        ],
    ),
    "Languages": ModelInfo(
        name="Languages",
    ...
    "LinkTemplate": ModelInfo(
        ...
        used_in_endpoints=[
            ...
            "POST /rest/ofscMetadata/v1/linkTemplates/{label}",
    ...
    "CustomMapLayer": ModelInfo(
        ...
        inheritance=[],
        used_in_endpoints=[
            "POST /rest/ofscMetadata/v1/mapLayers",
            "PUT /rest/ofscMetadata/v1/mapLayers/{label}",
    ...
    "CustomActionMapLayersPopulateLayersSchemaResponse": ModelInfo(
        ...
        inheritance=[],
        used_in_endpoints=[
            "GET /rest/ofscMetadata/v1/mapLayers/custom-actions/populateLayers/{downloadId}",
    ...
    "PropertyGet": ModelInfo(
        ...
        inheritance=[],
        used_in_endpoints=[
            "GET /rest/ofscMetadata/v1/properties/{label}",
            "PATCH /rest/ofscMetadata/v1/properties/{label}",
        ],
        used_in_request_endpoints=[],
        used_in_response_endpoints=[
            "GET /rest/ofscMetadata/v1/properties/{label}",
    ...
    "Property": ModelInfo(
        ...
        inheritance=[],
        used_in_endpoints=[
            "PUT /rest/ofscMetadata/v1/properties/{label}",
            "PATCH /rest/ofscMetadata/v1/properties/{label}",
            "PUT /rest/ofscMetadata/v1/properties/{label}",
        ],
        used_in_request_endpoints=[
    ...
    "PropertyEnumerations": ModelInfo(
        ...
        inheritance=[],
        used_in_endpoints=[
            "GET /rest/ofscMetadata/v1/properties/{label}/enumerationList"
        ],
        used_in_request_endpoints=[],
        used_in_response_endpoints=[
            "GET /rest/ofscMetadata/v1/properties/{label}/enumerationList"
    ...
    "PropertyEnumeration": ModelInfo(
        ...
        inheritance=[],
        used_in_endpoints=[
            "PUT /rest/ofscMetadata/v1/properties/{label}/enumerationList"
        ],
        used_in_request_endpoints=[],
        used_in_response_endpoints=[
            "PUT /rest/ofscMetadata/v1/properties/{label}/enumerationList"
    ...
    "routingPlanLabels": ModelInfo(
        ...
        inheritance=[],
        used_in_endpoints=[
            "GET /rest/ofscMetadata/v1/routingProfiles/{profileLabel}/plans"
        ],
        used_in_request_endpoints=[],
        used_in_response_endpoints=[
            "GET /rest/ofscMetadata/v1/routingProfiles/{profileLabel}/plans"
    ...
    "file": ModelInfo(
        ...
        inheritance=[],
        used_in_endpoints=[
            "GET /rest/ofscMetadata/v1/routingProfiles/{profileLabel}/plans/{planLabel}/custom-actions/export",
            "GET /rest/ofscCore/v1/activities/{activityId}/{propertyLabel}",
            "GET /rest/ofscCore/v1/folders/dailyExtract/folders/{dailyExtractDate}/files/{dailyExtractFilename}",
            "GET /rest/ofscCore/v1/inventories/{inventoryId}/{propertyLabel}",
            "GET /rest/ofscCore/v1/resources/{resourceId}/{propertyLabel}",
            "GET /rest/ofscCore/v1/serviceRequests/{requestId}/{propertyLabel}",
            "GET /rest/ofscCore/v1/users/{login}/{propertyLabel}",
        ],
        used_in_request_endpoints=[],
        used_in_response_endpoints=[
            "GET /rest/ofscMetadata/v1/routingProfiles/{profileLabel}/plans/{planLabel}/custom-actions/export",
    ...
    "Shift": ModelInfo(
        ...
        inheritance=[],
        used_in_endpoints=[
            "GET /rest/ofscMetadata/v1/shifts/{label}",
            "PUT /rest/ofscMetadata/v1/shifts/{label}",
        ],
        used_in_request_endpoints=[],
        used_in_response_endpoints=[
            "GET /rest/ofscMetadata/v1/shifts/{label}",
    ...
    "WorkSkillConditions": ModelInfo(
        ...
        inheritance=[],
        used_in_endpoints=[
            "GET /rest/ofscMetadata/v1/workSkillConditions",
            "PUT /rest/ofscMetadata/v1/workSkillConditions",
        ],
        used_in_request_endpoints=[],
        used_in_response_endpoints=[
            "GET /rest/ofscMetadata/v1/workSkillConditions",
    ...
    "WorkSkillGroup": ModelInfo(
        ...
        required_properties=[
            "assignToResource",
            "addToCapacityCategory",
            "active",
            "translations",
        ],
        inheritance=[],
        used_in_endpoints=[
            "PUT /rest/ofscMetadata/v1/workSkillGroups/{label}",
            "GET /rest/ofscMetadata/v1/workSkillGroups/{label}",
            "PUT /rest/ofscMetadata/v1/workSkillGroups/{label}",
        ],
    ...
    "WorkSkill": ModelInfo(
        ...
        inheritance=[],
        used_in_endpoints=[
            "PUT /rest/ofscMetadata/v1/workSkills/{label}",
            "GET /rest/ofscMetadata/v1/workSkills/{label}",
            "PUT /rest/ofscMetadata/v1/workSkills/{label}",
        ],
    ...
    "workZones": ModelInfo(
        ...
        inheritance=[],
        used_in_endpoints=[
            "PUT /rest/ofscMetadata/v1/workZones",
            "PATCH /rest/ofscMetadata/v1/workZones",
            "GET /rest/ofscMetadata/v1/workZones",
        ],
        used_in_request_endpoints=[
            "PUT /rest/ofscMetadata/v1/workZones",
            "PATCH /rest/ofscMetadata/v1/workZones",
    ...
    "workZoneItem": ModelInfo(
        ...
        used_in_endpoints=[
            ...
            "PUT /rest/ofscMetadata/v1/workZones/{label}",
    ...
    "customActionWorkZonesPopulateShapesSchemaResponse": ModelInfo(
        ...
        inheritance=[],
        used_in_endpoints=[
            "GET /rest/ofscMetadata/v1/workZones/custom-actions/populateShapes/{downloadId}",
            "POST /rest/ofscMetadata/v1/workZones/custom-actions/populateShapes",
        ],
        used_in_request_endpoints=[],
        used_in_response_endpoints=[
            "GET /rest/ofscMetadata/v1/workZones/custom-actions/populateShapes/{downloadId}",
    ...
    "activityDurationsList": ModelInfo(
        ...
        used_in_request_endpoints=[],
        used_in_response_endpoints=[
            "GET /rest/ofscStatistics/v1/activityDurationStats"
        ],
        mapped_pydantic_class=None,
        module="statistics",
        schema_type="object",
    ...
    "activityDurationRequestList": ModelInfo(
        ...
        used_in_request_endpoints=[
            "PATCH /rest/ofscStatistics/v1/activityDurationStats"
        ],
        used_in_response_endpoints=[],
        mapped_pydantic_class=None,
        module="statistics",
    ...
    "activityTravelPatchResponse": ModelInfo(
        ...
        used_in_request_endpoints=[],
        used_in_response_endpoints=[
            "PATCH /rest/ofscStatistics/v1/activityTravelStats"
        ],
        mapped_pydantic_class=None,
        module="statistics",
        schema_type="object",
    ...
    "airlineDistanceBasedTravelList": ModelInfo(
        ...
        used_in_request_endpoints=[],
        used_in_response_endpoints=[
            "GET /rest/ofscStatistics/v1/airlineDistanceBasedTravel"
        ],
        mapped_pydantic_class=None,
        module="statistics",
        schema_type="object",
    ...
    "airlineDistanceBasedTravel": ModelInfo(
        ...
        properties=[
            ...
            ModelProperty(
                ...
                items={
                    "type": "unknown",
                    "$ref": "airlineDistanceBasedTravelDataResponse",
                },
            ),
            ModelProperty(
                name="keyId",
    ...
    "airlineDistanceBasedTravelRequestList": ModelInfo(
        ...
        used_in_request_endpoints=[
            "PATCH /rest/ofscStatistics/v1/airlineDistanceBasedTravel"
        ],
        used_in_response_endpoints=[],
        mapped_pydantic_class=None,
        module="statistics",
    ...
    "airlineDistanceBasedTravelRequest": ModelInfo(
        ...
        properties=[
            ...
            ModelProperty(
                ...
                items={
                    "type": "unknown",
                    "$ref": "airlineDistanceBasedTravelOverrideData",
                },
            ),
            ModelProperty(
                name="keyId",
    ...
    "catalogSchema": ModelInfo(
        ...
        inheritance=[],
        used_in_endpoints=[
            "PUT /rest/ofscPartsCatalog/v1/catalogs/{catalog}/{language}"
        ],
        used_in_request_endpoints=[
            "PUT /rest/ofscPartsCatalog/v1/catalogs/{catalog}/{language}"
        ],
    ...
    "catalogItem": ModelInfo(
        ...
        inheritance=[],
        used_in_endpoints=[
            "PUT /rest/ofscPartsCatalog/v1/catalogs/{catalog}/{language}/{itemLabel}"
        ],
        used_in_request_endpoints=[
            "PUT /rest/ofscPartsCatalog/v1/catalogs/{catalog}/{language}/{itemLabel}"
        ],
    ...
    "ParticipantList": ModelInfo(
        ...
        inheritance=[],
        used_in_endpoints=[
            "GET /rest/ofscCollaboration/v1/chats/{chatId}/participants"
        ],
        used_in_request_endpoints=[],
        used_in_response_endpoints=[
            "GET /rest/ofscCollaboration/v1/chats/{chatId}/participants"
    ...
    "GetMessageResponse": ModelInfo(
        ...
        used_in_request_endpoints=[],
        used_in_response_endpoints=[
            "GET /rest/ofscCollaboration/v1/chats/{chatId}/messages"
        ],
        mapped_pydantic_class=None,
        module="collaboration",
        schema_type="object",
    ...
    "InviteChatRequest": ModelInfo(
        ...
        inheritance=[],
        used_in_endpoints=[
            "POST /rest/ofscCollaboration/v1/chats/{chatId}/participants/invite"
        ],
        used_in_request_endpoints=[
            "POST /rest/ofscCollaboration/v1/chats/{chatId}/participants/invite"
        ],
    ...
    "activities": ModelInfo(
        ...
        inheritance=[],
        used_in_endpoints=[
            "GET /rest/ofscCore/v1/activities/{activityId}/multidaySegments",
            "GET /rest/ofscCore/v1/activities/custom-actions/search",
        ],
        used_in_request_endpoints=[],
        used_in_response_endpoints=[
            "GET /rest/ofscCore/v1/activities/{activityId}/multidaySegments",
    ...
    "activity": ModelInfo(
        ...
        examples=[],
        nested_models=[
            "activityAccessSchedule",
            "serviceWindowStartOutput",
            "serviceWindowEndOutput",
            "timeDeliveredEndInput",
            "slaWindowStartOutput",
            "durationOutput",
            "slaWindowEndOutput",
            "timeDeliveredStartInput",
        ],
        parent_models=[
            "activities",
            "getActivitiesResponse",
            "findNearbyActivitiesItem",
            "route",
        ],
    ),
    "createActivitySchema": ModelInfo(
        ...
        nested_models=[
            "activityAccessSchedule",
            "serviceWindowStartInput",
            "slaWindowStartInput",
            "serviceWindowEndInput",
            "setTravelTimeRequestField",
            "slaWindowEndInput",
            "timeDeliveredEndInput",
            "setPositionInRouteRequestField",
            "timeDeliveredStartInput",
            "durationInput",
        ],
        parent_models=[],
    ...
    "activityFMRSchema": ModelInfo(
        ...
        parent_models=[
            "findMatchingResourcesRequestSchema",
            "findResourcesForUrgentAssignmentRequestSchema",
        ],
    ),
    "getActivitySchema": ModelInfo(
        ...
        used_in_endpoints=[
            ...
            "POST /rest/ofscCore/v1/activities/{activityId}/custom-actions/startPrework",
            "POST /rest/ofscCore/v1/activities/{activityId}/custom-actions/reopen",
            "POST /rest/ofscCore/v1/activities/{activityId}/custom-actions/delay",
            "POST /rest/ofscCore/v1/activities/{activityId}/custom-actions/cancel",
            "POST /rest/ofscCore/v1/activities/{activityId}/custom-actions/start",
            "POST /rest/ofscCore/v1/activities/{activityId}/custom-actions/enroute",
            "POST /rest/ofscCore/v1/activities/{activityId}/custom-actions/stopTravel",
            "POST /rest/ofscCore/v1/activities/{activityId}/custom-actions/suspend",
            "POST /rest/ofscCore/v1/activities/{activityId}/custom-actions/complete",
            "POST /rest/ofscCore/v1/activities/{activityId}/custom-actions/notDone",
        ],
        used_in_request_endpoints=[],
        used_in_response_endpoints=[
            "PATCH /rest/ofscCore/v1/activities/{activityId}",
    ...
    "resourcePreferences": ModelInfo(
        ...
        inheritance=[],
        used_in_endpoints=[
            "PUT /rest/ofscCore/v1/activities/{activityId}/resourcePreferences",
            "GET /rest/ofscCore/v1/activities/{activityId}/resourcePreferences",
        ],
        used_in_request_endpoints=[
            "PUT /rest/ofscCore/v1/activities/{activityId}/resourcePreferences"
        ],
    ...
    "createCustomerInventory": ModelInfo(
        ...
        inheritance=[],
        used_in_endpoints=[
            "POST /rest/ofscCore/v1/activities/{activityId}/customerInventories"
        ],
        used_in_request_endpoints=[
            "POST /rest/ofscCore/v1/activities/{activityId}/customerInventories"
        ],
    ...
    "requiredInventories": ModelInfo(
        ...
        inheritance=[],
        used_in_endpoints=[
            "PUT /rest/ofscCore/v1/activities/{activityId}/requiredInventories",
            "GET /rest/ofscCore/v1/activities/{activityId}/requiredInventories",
        ],
        used_in_request_endpoints=[
            "PUT /rest/ofscCore/v1/activities/{activityId}/requiredInventories"
        ],
    ...
    "linkedActivities": ModelInfo(
        ...
        inheritance=[],
        used_in_endpoints=[
            "GET /rest/ofscCore/v1/activities/{activityId}/linkedActivities"
        ],
        used_in_request_endpoints=[],
        used_in_response_endpoints=[
            "GET /rest/ofscCore/v1/activities/{activityId}/linkedActivities"
    ...
    "linkedActivity": ModelInfo(
        ...
        inheritance=[],
        used_in_endpoints=[
            "POST /rest/ofscCore/v1/activities/{activityId}/linkedActivities",
            "PUT /rest/ofscCore/v1/activities/{activityId}/linkedActivities/{linkedActivityId}/linkTypes/{linkType}",
            "GET /rest/ofscCore/v1/activities/{activityId}/linkedActivities/{linkedActivityId}/linkTypes/{linkType}",
            "PUT /rest/ofscCore/v1/activities/{activityId}/linkedActivities/{linkedActivityId}/linkTypes/{linkType}",
        ],
        used_in_request_endpoints=[
            "POST /rest/ofscCore/v1/activities/{activityId}/linkedActivities",
    ...
    "getCapacityCategoriesSchema": ModelInfo(
        ...
        inheritance=[],
        used_in_endpoints=[
            "GET /rest/ofscCore/v1/activities/{activityId}/capacityCategories"
        ],
        used_in_request_endpoints=[],
        used_in_response_endpoints=[
            "GET /rest/ofscCore/v1/activities/{activityId}/capacityCategories"
    ...
    "bulkUpdateActivityItemSchema": ModelInfo(
        ...
        nested_models=[
            "resourcePreferences",
            "inventoryWithCustomProperties",
            "bulkUpdateLinkedActivities",
            "requiredInventories",
            "bulkUpdateActivitySchema",
        ],
    ...
    "setPositionInRouteRequestField": ModelInfo(
        ...
        parent_models=[
            ...
            "activityFMRSchema",
            "bulkUpdateActivitySchema",
            "customActionActivityMoveSchema",
            "reopenActivityRequest",
        ],
    ),
    ...
    "customActionActivityBulkUpdateSchema": ModelInfo(
        ...
        inheritance=[],
        used_in_endpoints=[
            "POST /rest/ofscCore/v1/activities/custom-actions/bulkUpdate"
        ],
        used_in_request_endpoints=[
            "POST /rest/ofscCore/v1/activities/custom-actions/bulkUpdate"
        ],
    ...
    "dailyExtractDateFiles": ModelInfo(
        ...
        inheritance=[],
        used_in_endpoints=[
            "GET /rest/ofscCore/v1/folders/dailyExtract/folders/{dailyExtractDate}/files"
        ],
        used_in_request_endpoints=[],
        used_in_response_endpoints=[
            "GET /rest/ofscCore/v1/folders/dailyExtract/folders/{dailyExtractDate}/files"
    ...
    "dailyExtractSubfolders": ModelInfo(
        ...
        used_in_request_endpoints=[],
        used_in_response_endpoints=[
            "GET /rest/ofscCore/v1/folders/dailyExtract/folders"
        ],
        mapped_pydantic_class=None,
        module="core",
        schema_type="object",
    ...
    "activityDetails": ModelInfo(
        ...
        nested_models=[],
        parent_models=[
            "requiredInventoryEvent",
            "requestEvent",
            "activityLinkEvent",
            "activityEvent",
            "resourcePreferenceEvent",
            "inventoryEvent",
        ],
    ),
    ...
    "resourceDetails": ModelInfo(
        ...
        parent_models=[
            "resourceEvent",
            "findResourcesForUrgentAssignmentResponseSchema",
        ],
    ),
    ...
    "subscriptionInfoResponse": ModelInfo(
        ...
        used_in_endpoints=[
            "GET /rest/ofscCore/v1/events/subscriptions/{subscriptionId}"
        ],
        used_in_request_endpoints=[],
        used_in_response_endpoints=[
            "GET /rest/ofscCore/v1/events/subscriptions/{subscriptionId}"
    ...
    "inventory": ModelInfo(
        ...
        inheritance=["inventoryWithoutStatus"],
        used_in_endpoints=[
            "PATCH /rest/ofscCore/v1/inventories/{inventoryId}",
            "PATCH /rest/ofscCore/v1/inventories/{inventoryId}",
            "GET /rest/ofscCore/v1/inventories/{inventoryId}",
        ],
    ...
    "inventoryCustomActionSchema": ModelInfo(
        ...
        inheritance=[],
        used_in_endpoints=[
            "POST /rest/ofscCore/v1/inventories/{inventoryId}/custom-actions/undoInstall",
            "POST /rest/ofscCore/v1/inventories/{inventoryId}/custom-actions/undoDeinstall",
            "POST /rest/ofscCore/v1/inventories/{inventoryId}/custom-actions/install",
            "POST /rest/ofscCore/v1/inventories/{inventoryId}/custom-actions/deinstall",
            "POST /rest/ofscCore/v1/resources/{resourceId}/inventories/{inventoryId}/custom-actions/install",
        ],
        used_in_request_endpoints=[
            "POST /rest/ofscCore/v1/inventories/{inventoryId}/custom-actions/undoInstall",
            "POST /rest/ofscCore/v1/inventories/{inventoryId}/custom-actions/undoDeinstall",
    ...
    "resources": ModelInfo(
        ...
        used_in_endpoints=[
            ...
            "GET /rest/ofscCore/v1/resources/{resourceId}/children",
    ...
    "resourcesAssistants": ModelInfo(
        ...
        used_in_request_endpoints=[],
        used_in_response_endpoints=[
            "GET /rest/ofscCore/v1/resources/{resourceId}/assistants"
        ],
        mapped_pydantic_class=None,
        module="core",
        schema_type="object",
    ...
    "resource": ModelInfo(
        ...
        used_in_endpoints=[
            ...
            "PUT /rest/ofscCore/v1/resources/{resourceId}",
            "PATCH /rest/ofscCore/v1/resources/{resourceId}",
        ],
        used_in_request_endpoints=[],
        used_in_response_endpoints=[
            "GET /rest/ofscCore/v1/resources/{resourceId}",
        ...
        parent_models=[
            "resourceEvent",
            "resources",
            "findMatchingResourcesResponseSchema",
        ],
    ),
    ...
    "resourceWorkZone": ModelInfo(
        ...
        used_in_request_endpoints=[
            "POST /rest/ofscCore/v1/resources/{resourceId}/workZones"
        ],
        used_in_response_endpoints=[],
        mapped_pydantic_class=None,
        module="core",
    ...
    "resourceWorkSkill": ModelInfo(
        ...
        parent_models=[
            "workSkills",
            "setWorkSkillsRequest",
            "bulkUpdateWorkSkillsSchema",
        ],
    ),
    "workSkills": ModelInfo(
        name="workSkills",
        ...
        inheritance=[],
        used_in_endpoints=[
            "POST /rest/ofscCore/v1/resources/{resourceId}/workSkills",
    ...
    "workSchedules": ModelInfo(
        ...
        inheritance=[],
        used_in_endpoints=[
            "GET /rest/ofscCore/v1/resources/{resourceId}/workSchedules",
            "POST /rest/ofscCore/v1/resources/{resourceId}/workSchedules",
        ],
        used_in_request_endpoints=[],
        used_in_response_endpoints=[
            "GET /rest/ofscCore/v1/resources/{resourceId}/workSchedules",
    ...
    "workSchedulesCalendarView": ModelInfo(
        ...
        inheritance=[],
        used_in_endpoints=[
            "GET /rest/ofscCore/v1/resources/{resourceId}/workSchedules/calendarView"
        ],
        used_in_request_endpoints=[],
        used_in_response_endpoints=[
            "GET /rest/ofscCore/v1/resources/{resourceId}/workSchedules/calendarView"
    ...
    "findNearbyActivitiesResponse": ModelInfo(
        ...
        inheritance=[],
        used_in_endpoints=[
            "GET /rest/ofscCore/v1/resources/{resourceId}/findNearbyActivities"
        ],
        used_in_request_endpoints=[],
        used_in_response_endpoints=[
            "GET /rest/ofscCore/v1/resources/{resourceId}/findNearbyActivities"
    ...
    "resourceInventories": ModelInfo(
        ...
        used_in_request_endpoints=[],
        used_in_response_endpoints=[
            "GET /rest/ofscCore/v1/resources/{resourceId}/inventories"
        ],
        mapped_pydantic_class=None,
        module="core",
        schema_type="object",
    ...
    "createResourceInventory": ModelInfo(
        ...
        used_in_request_endpoints=[
            "POST /rest/ofscCore/v1/resources/{resourceId}/inventories"
        ],
        used_in_response_endpoints=[],
        mapped_pydantic_class=None,
        module="core",
    ...
    "resourceUsers": ModelInfo(
        ...
        inheritance=[],
        used_in_endpoints=[
            "PUT /rest/ofscCore/v1/resources/{resourceId}/users",
            "GET /rest/ofscCore/v1/resources/{resourceId}/users",
            "PUT /rest/ofscCore/v1/resources/{resourceId}/users",
        ],
        used_in_request_endpoints=[
            "PUT /rest/ofscCore/v1/resources/{resourceId}/users"
    ...
    "resourceAssignedLocationsWeek": ModelInfo(
        ...
        inheritance=[],
        used_in_endpoints=[
            "PUT /rest/ofscCore/v1/resources/{resourceId}/assignedLocations",
            "PUT /rest/ofscCore/v1/resources/{resourceId}/assignedLocations",
            "GET /rest/ofscCore/v1/resources/{resourceId}/assignedLocations",
        ],
        used_in_request_endpoints=[
            "PUT /rest/ofscCore/v1/resources/{resourceId}/assignedLocations"
        ],
    ...
    "resourceTemporaryAssignedLocationsWeek": ModelInfo(
        ...
        inheritance=[],
        used_in_endpoints=[
            "PATCH /rest/ofscCore/v1/resources/{resourceId}/assignedLocations"
        ],
        used_in_request_endpoints=[
            "PATCH /rest/ofscCore/v1/resources/{resourceId}/assignedLocations"
        ],
    ...
    "resourcePositions": ModelInfo(
        ...
        inheritance=[],
        used_in_endpoints=[
            "GET /rest/ofscCore/v1/resources/{resourceId}/positionHistory"
        ],
        used_in_request_endpoints=[],
        used_in_response_endpoints=[
            "GET /rest/ofscCore/v1/resources/{resourceId}/positionHistory"
    ...
    "resourceAssignedLocationsDay": ModelInfo(
        ...
        nested_models=[],
        parent_models=[
            "resourceAssignedLocationsWeek",
            "resourceTemporaryAssignedLocationsWeek",
        ],
    ),
    "plan": ModelInfo(
        name="plan",
        ...
        used_in_request_endpoints=[
            "POST /rest/ofscCore/v1/resources/{resourceId}/plans"
        ],
        used_in_response_endpoints=[],
        mapped_pydantic_class=None,
        module="core",
    ...
    "bulkUpdateWorkSchedulesResponseSchema": ModelInfo(
        ...
        inheritance=[],
        used_in_endpoints=[
            "POST /rest/ofscCore/v1/resources/custom-actions/bulkUpdateWorkSchedules"
        ],
        used_in_request_endpoints=[],
        used_in_response_endpoints=[
            "POST /rest/ofscCore/v1/resources/custom-actions/bulkUpdateWorkSchedules"
    ...
    "bulkUpdateWorkSkillsResponseSchema": ModelInfo(
        ...
        inheritance=[],
        used_in_endpoints=[
            "POST /rest/ofscCore/v1/resources/custom-actions/bulkUpdateWorkSkills"
        ],
        used_in_request_endpoints=[],
        used_in_response_endpoints=[
            "POST /rest/ofscCore/v1/resources/custom-actions/bulkUpdateWorkSkills"
    ...
    "bulkUpdateWorkZonesResponseSchema": ModelInfo(
        ...
        inheritance=[],
        used_in_endpoints=[
            "POST /rest/ofscCore/v1/resources/custom-actions/bulkUpdateWorkZones"
        ],
        used_in_request_endpoints=[],
        used_in_response_endpoints=[
            "POST /rest/ofscCore/v1/resources/custom-actions/bulkUpdateWorkZones"
    ...
    "bulkUpdateResourceInventoriesRequestResourceSchema": ModelInfo(
        ...
        properties=[
            ...
            ModelProperty(
                ...
                items={
                    "type": "unknown",
                    "$ref": "bulkUpdateResourceInventoriesRequestInventorySchema",
                },
            ),
        ],
        ...
        examples=[],
        nested_models=[
            "bulkUpdateResourceInventoriesRequestInventorySchema",
    ...
    "bulkUpdateResourceInventoriesRequestSchema": ModelInfo(
        ...
        properties=[
            ModelProperty(
                ...
                items={
                    "type": "unknown",
                    "$ref": "bulkUpdateResourceInventoriesRequestResourceSchema",
                },
            ),
        ],
        ...
        inheritance=[],
        used_in_endpoints=[
            "POST /rest/ofscCore/v1/resources/custom-actions/bulkUpdateInventories"
        ],
        used_in_request_endpoints=[
            "POST /rest/ofscCore/v1/resources/custom-actions/bulkUpdateInventories"
        ],
    ...
    "bulkUpdateResourceInventoriesResponseSchema": ModelInfo(
        ...
        properties=[
            ...
            ModelProperty(
                ...
                items={
                    "type": "unknown",
                    "$ref": "bulkUpdateResourceInventoriesResponseResultSchema",
                },
            ),
        ],
        required_properties=[],
    ...
    "findResourcesForUrgentAssignmentResponseSchema": ModelInfo(
        ...
        inheritance=[],
        used_in_endpoints=[
            "POST /rest/ofscCore/v1/resources/custom-actions/findResourcesForUrgentAssignment"
        ],
        used_in_request_endpoints=[],
        used_in_response_endpoints=[
            "POST /rest/ofscCore/v1/resources/custom-actions/findResourcesForUrgentAssignment"
    ...
    "setResourcesPositionsRequestSchema": ModelInfo(
        ...
        properties=[
            ModelProperty(
                ...
                items={
                    "type": "unknown",
                    "$ref": "setResourcesPositionsRequestPositionSchema",
                },
            ),
        ],
        required_properties=["items"],
        inheritance=[],
        used_in_endpoints=[
            "POST /rest/ofscCore/v1/resources/custom-actions/setPositions"
        ],
        used_in_request_endpoints=[
            "POST /rest/ofscCore/v1/resources/custom-actions/setPositions"
        ],
    ...
    "lastKnownResourcesPositionsResponseSchema": ModelInfo(
        ...
        properties=[
            ModelProperty(
                ...
                items={
                    "type": "unknown",
                    "$ref": "lastKnownResourcesPositionsResponsePositionSchema",
                },
            ),
            ModelProperty(
                name="totalResults",
        ...
        inheritance=[],
        used_in_endpoints=[
            "GET /rest/ofscCore/v1/resources/custom-actions/lastKnownPositions"
        ],
        used_in_request_endpoints=[],
        used_in_response_endpoints=[
            "GET /rest/ofscCore/v1/resources/custom-actions/lastKnownPositions"
    ...
    "resourcesInAreaResponseSchema": ModelInfo(
        ...
        properties=[
            ModelProperty(
                ...
                items={
                    "type": "unknown",
                    "$ref": "resourcesInAreaResponseResourceSchema",
                },
            ),
            ModelProperty(
                name="totalResults",
        ...
        inheritance=[],
        used_in_endpoints=[
            "GET /rest/ofscCore/v1/resources/custom-actions/resourcesInArea"
        ],
        used_in_request_endpoints=[],
        used_in_response_endpoints=[
            "GET /rest/ofscCore/v1/resources/custom-actions/resourcesInArea"
    ...
    "inventoryPropertiesUpdateMode": ModelInfo(
        ...
        nested_models=[],
        parent_models=[
            "customActionActivityBulkUpdateSchema",
            "bulkUpdateResourceInventoriesRequestResourceSchema",
        ],
    ),
    ...
    "collaborationGroups": ModelInfo(
        ...
        inheritance=[],
        used_in_endpoints=[
            "POST /rest/ofscCore/v1/users/{login}/collaborationGroups",
            "GET /rest/ofscCore/v1/users/{login}/collaborationGroups",
        ],
        used_in_request_endpoints=[
            "POST /rest/ofscCore/v1/users/{login}/collaborationGroups"
        ],
    ...
    "userResponse": ModelInfo(
        ...
        used_in_endpoints=[
            ...
            "PATCH /rest/ofscCore/v1/users/{login}",
        ],
        used_in_request_endpoints=[],
        used_in_response_endpoints=[
            "PUT /rest/ofscCore/v1/users/{login}",
    ...
    "bookingClosingScheduleList": ModelInfo(
        ...
        inheritance=[],
        used_in_endpoints=[
            "PATCH /rest/ofscCapacity/v1/bookingClosingSchedule",
            "GET /rest/ofscCapacity/v1/bookingClosingSchedule",
        ],
        used_in_request_endpoints=[
            "PATCH /rest/ofscCapacity/v1/bookingClosingSchedule"
        ],
    ...
    "v2-patch-quota-time-slots": ModelInfo(
        ...
        properties=[
            ...
            ModelProperty(
                ...
                items={
                    "type": "unknown",
                    "$ref": "v2-patch-quota-time-slot-categories",
                },
            ),
        ],
        required_properties=[],
    ...
    "v2-patch-quota-categories": ModelInfo(
        ...
        examples=[],
        nested_models=[
            "v2-patch-quota-category-intervals",
            "v2-patch-quota-work-zones",
        ],
        parent_models=["v2-patch-quota-area"],
    ),
    "v2-patch-quota-work-zones": ModelInfo(
        ...
        nested_models=[],
        parent_models=[
            "v2-patch-quota-time-slot-categories",
            "v2-patch-quota-category-intervals",
            "v2-patch-quota-categories",
        ],
    ),
    ...
    "v2-quota-area": ModelInfo(
        ...
        examples=[],
        nested_models=[
            "v2-quota-area-categories",
            "v2-quota-area-intervals",
            "v2-quota-area-time-slots",
        ],
    ...
    "v2-quota-work-zones": ModelInfo(
        ...
        nested_models=[],
        parent_models=[
            "v2-quota-time-slot-categories",
            "v2-quota-area-categories",
            "v2-quota-category-intervals",
        ],
    ),
...
def get_models_for_endpoint(method: str, path: str) -> List[ModelInfo]:
    ...
    return [
        model for model in MODELS.values() if endpoint_key in model.used_in_endpoints
    ]
...
def get_models_with_pydantic_mapping() -> List[ModelInfo]:
    ...
    return [
        model for model in MODELS.values() if model.mapped_pydantic_class is not None
    ]
...
def generate_mapping_coverage_report() -> Dict[str, Any]:
    ...
    for module in set(model.module for model in MODELS.values()):
        ...
        by_module[module] = {
            ...
            "coverage_percentage": (len(module_mapped) / len(module_models) * 100)
            if module_models
            else 0,
        }
    ...
    return {
        ...
        "overall_coverage_percentage": (mapped_models / total_models * 100)
        if total_models > 0
        else 0,
        "by_module": by_module,
...
# Summary statistics
TOTAL_MODELS = len(MODELS)
MODELS_COUNT_BY_MODULE = {
    module: len(models) for module, models in MODELS_BY_MODULE.items()
}
MAPPED_MODELS_COUNT = len(MODELS_WITH_PYDANTIC_MAPPING)
UNMAPPED_MODELS_COUNT = len(MODELS_WITHOUT_PYDANTIC_MAPPING)
OVERALL_MAPPING_COVERAGE = (
    (MAPPED_MODELS_COUNT / TOTAL_MODELS * 100) if TOTAL_MODELS > 0 else 0
)
