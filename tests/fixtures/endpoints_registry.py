...
ENDPOINTS_COUNT_BY_MODULE = {
    module: len(endpoints) for module, endpoints in ENDPOINTS_BY_MODULE.items()
}
ENDPOINTS_COUNT_BY_METHOD = {
    method: len(endpoints) for method, endpoints in ENDPOINTS_BY_METHOD.items()
}
