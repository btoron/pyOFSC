...
from ofsc.models.metadata import ActivityTypeGroup
    ...
    def test_sunrise_client_create_or_replace_capacity_category(
        ...
        async def test_async_client_basic_auth(async_client_basic_auth):
            async with async_client_basic_auth as client:
                ...
                translations = TranslationList([
                    Translation(language="en", name="Test Capacity Category", languageISO="en-US"),
                    Translation(language="es", name="Categoría de Capacidad de Prueba", languageISO="es-ES")
                ])
                ...
                fetched_category = await client.metadata.get_capacity_category(test_category_label)
                ...
                try:
                    ...
                    assert False, "Expected exception when fetching deleted capacity category"
                except Exception:
