...
def init_script():
    ...
    logging.info("Creating instance connection for {} {}".format(Config.OFSC_COMPANY, Config.OFSC_CLIENT_ID))
    return instance


def get_users(instance):
    response = instance.get_users( offset=0, limit=100, response_type=JSON_RESPONSE)
