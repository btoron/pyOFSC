...
class APITestBase:
    ...
    CLEANUP_ORDER: List[str] = ["reverse"]  # or specific order like ["users", "activities", "resources"]
    ...
    async def assert_response_model(self, 
                                  response: Any,
                                  model_class: Type[T],
    ...
    async def assert_error_response(self,
                                  error: Exception,
                                  expected_status: int,
    ...
    async def wait_for_eventual_consistency(self, 
                                          check_func,
                                          timeout: int = 30,
                                          interval: int = 2):
        ...
        raise TimeoutError(f"Eventual consistency not achieved within {timeout} seconds")
