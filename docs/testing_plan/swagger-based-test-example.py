        ...
        if field_type == "string":
            ...
            if "enum" in field_schema:
                ...
                for enum_value in field_schema["enum"]:
                    test_cases.append(ParameterTestCase(
                        ...
                        parameters=create_minimal_params({field_name: enum_value}, required_fields, properties),
                ...
                test_cases.append(ParameterTestCase(
                    ...
                    parameters=create_minimal_params({field_name: "INVALID"}, required_fields, properties),
                    expected_status=400,
            ...
            if "minLength" in field_schema or "maxLength" in field_schema:
                ...
                test_cases.extend([
                    ParameterTestCase(
                        ...
                        parameters=create_minimal_params({field_name: "A" * min_len}, required_fields, properties),
                    ...
                    ParameterTestCase(
                        ...
                        category=TestCategory.BOUNDARY,
                        parameters=create_minimal_params({field_name: "A" * max_len}, required_fields, properties),
                    ...
                    ParameterTestCase(
                        ...
                        category=TestCategory.NEGATIVE,
                        parameters=create_minimal_params({field_name: "A" * (max_len + 1)}, required_fields, properties),
                        expected_status=400,
            ...
            test_cases.extend([
                ParameterTestCase(
                    ...
                    category=TestCategory.BOUNDARY,
                    parameters=create_minimal_params({field_name: min_val}, required_fields, properties),
                ...
                ParameterTestCase(
                    ...
                    category=TestCategory.BOUNDARY,
                    parameters=create_minimal_params({field_name: max_val}, required_fields, properties),
                ...
                ParameterTestCase(
                    ...
                    category=TestCategory.NEGATIVE,
                    parameters=create_minimal_params({field_name: min_val - 1}, required_fields, properties),
                    expected_status=400,
            ...
            test_cases.extend([
                ParameterTestCase(
                    ...
                    category=TestCategory.BOUNDARY,
                    parameters=create_minimal_params({field_name: []}, required_fields, properties),
...
def create_minimal_params(overrides: Dict[str, Any], 
...
def get_test_cases_for_endpoint(endpoint: str, operation: str) -> List[ParameterTestCase]:
